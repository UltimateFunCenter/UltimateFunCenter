...
namespace UltimateFunCenter.Controllers
{
    public class FacilitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] Facility facility)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Facility facility)
        {
            if (id != facility.Id)
            {
                return NotFound();
